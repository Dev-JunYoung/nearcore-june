...
pub fn load_config(
    ...
    \"network\": Config {{
        ...
        \"ban_window\": 10800s,
        \"blacklist\": [],
        \"ttl_account_id_router\": 3600s,
        \"peer_stats_period\": 5s,
        \"monitor_peers_max_period\": 60s,
        \"peer_states_cache_size\": 1000,
        \"peer_expiration_duration\": 604800s,
        \"public_addrs\": [],
        ...
        \"experimental\": ExperimentalConfig {{
            ...
            \"tier1_connect_interval\": 60s,
            \"tier1_new_connections_per_attempt\": 50,
            \"network_config_overrides\": NetworkConfigOverrides {{
                \"connect_to_reliable_peers_on_startup\": None,
                \"max_send_peers\": None,
                \"routed_message_ttl\": None,
                \"max_routes_to_store\": None,
                \"highest_peer_horizon\": None,
                \"push_info_period_millis\": None,
                \"outbound_disabled\": None,
                \"accounts_data_broadcast_rate_limit_burst\": None,
                \"accounts_data_broadcast_rate_limit_qps\": None,
                \"routing_table_update_rate_limit_burst\": None,
                \"routing_table_update_rate_limit_qps\": None,
            }},
        }},
    }},
    \"consensus\": Consensus {{
        \"min_num_peers\": 3,
        \"block_production_tracking_delay\": 100ms,
        \"min_block_production_delay\": 600ms,
        \"max_block_production_delay\": 2s,
        \"max_block_wait_delay\": 6s,
        \"produce_empty_blocks\": true,
        \"block_fetch_horizon\": 50,
        \"state_fetch_horizon\": 5,
        \"block_header_fetch_horizon\": 50,
        \"catchup_step_period\": 100ms,
        \"chunk_request_retry_period\": 400ms,
        \"header_sync_initial_timeout\": 10s,
        \"header_sync_progress_timeout\": 2s,
        \"header_sync_stall_ban_timeout\": 120s,
        \"state_sync_timeout\": 60s,
        \"header_sync_expected_height_per_second\": 10,
        \"sync_check_period\": 10s,
        \"sync_step_period\": 10ms,
        \"doomslug_step_period\": 100ms,
    ...
    \"epoch_sync_enabled\": true,
    \"view_client_throttle_period\": 30s,
    ...
    \"store\": StoreConfig {{
        ...
        \"view_trie_cache\": TrieCacheConfig {{
            \"default_max_bytes\": 50000000,
            \"per_shard_max_bytes\": {{}},
        }},
    ...
    println!("      --------------------------------------------------");
    println!("node_key_path :  \n{:#?}", node_key_path);

    let network_signer_result = NodeKeyFile::from_file(&node_key_path);
    println!("      --------------------------------------------------");
    // println!("network_signer_result :  \n{:#?}", network_signer_result);
